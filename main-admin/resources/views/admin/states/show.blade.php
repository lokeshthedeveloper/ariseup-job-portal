...
<div class="row mb-4">
    <div class="col-md-8">
        <h2><i class="bi bi-map"></i> State Details</h2>
        ...
        <div class="card shadow-sm">
            ...
            <div class="card-body">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-8">
                        <span class="badge bg-{{ $state->status ? 'success' : 'secondary' }}">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-8">
                        {{ $state->created_at->format('F d, Y h:i A') }}
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-8">
                        {{ $state->updated_at->format('F d, Y h:i A') }}
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card shadow-sm">
            ...
            <div class="card-body">
                <div class="d-grid gap-2">
                    <a href="{{ route('admin.states.edit', $state) }}" class="btn btn-warning">
                        <i class="bi bi-pencil"></i> Edit State
                    </a>
                    ...
                    <form action="{{ route('admin.states.toggle-status', $state) }}"
                        ...
                        @csrf
                        @method('PATCH')
                        <button type="submit" class="btn btn-{{ $state->status ? 'secondary' : 'success' }} w-100">
                            <i class="bi bi-toggle-{{ $state->status ? 'off' : 'on' }}"></i>
        ...
        <div class="card shadow-sm mt-3">
            ...
            <div class="card-body">
                ...
                <p class="mb-0 small">
                    ...
                    {{ $state->created_at->diffForHumans() }}
                </p>
            </div>
        </div>
    </div>
