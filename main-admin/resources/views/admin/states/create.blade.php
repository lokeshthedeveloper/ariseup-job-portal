...
<div class="row mb-4">
    <div class="col-md-12">
        <h2><i class="bi bi-map"></i> Add New State</h2>
                ...
                <form action="{{ route('admin.states.store') }}" method="POST">
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <button type="submit" class="btn btn-primary">
                            <i class="bi bi-save"></i> Create State
                        </button>
                    </div>
                </form>
            </div>
        ...
        <div class="card shadow-sm">
            ...
            <div class="card-body">
                ...
                <div class="alert alert-info small">
                    <i class="bi bi-lightbulb"></i> <strong>Tip:</strong> Make sure the country exists before adding states to it.
                </div>
            </div>
        </div>
    </div>
