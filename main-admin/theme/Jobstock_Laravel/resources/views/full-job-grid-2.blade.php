<!-- resources/views/full-job-grid-2.blade.php -->
@extends('layouts.main')

@section('title', 'Full-Job-Grid-2 Page')
		...
		<div class="row">
			<div class="col-lg-12 col-md-12 col-sm-12">
				...
				<div class="row justify-content-center gx-xl-3 gx-3 gy-4">
					...
					<!-- includes/For-Candidate/Browse-Jobs/full-job-grid-2/jobs11.blade.php -->
					@include('includes.For-Candidate.Browse-Jobs.full-job-grid-2.jobs11')
