<!-- resources/views/full-job-list-1.blade.php -->
@extends('layouts.main')

@section('title', 'Full-Job-List-1 Page')
		...
		<div class="row">
			<div class="col-lg-12 col-md-12 col-sm-12">
				...
				<div class="row justify-content-start gx-3 gy-4">
					...
					<!-- includes/For-Candidate/Browse-Jobs/full-job-list-1/jobs15.blade.php -->
					@include('includes.For-Candidate.Browse-Jobs.full-job-list-1.jobs15')
