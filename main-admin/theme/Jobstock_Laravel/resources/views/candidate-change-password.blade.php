<!-- resources/views/candidate-change-password.blade.php -->
@extends('layouts.main')

@section('title', 'Candidate-Change-Password Page')
		...
		<div class="dashboard-nav">
			...
			<div class="dashboard-inner">
				<ul data-submenu-title="Main Navigation">
					...
					<li class="active"><a href="{{ url('/candidate-change-password') }}"><i class="fa-solid fa-unlock-keyhole me-2"></i>Change Password</a></li>
				...
				<div class="colxl-12 col-lg-12 col-md-12">
					...
					<nav aria-label="breadcrumb">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item"><a href="#" class="text-main">Change Password</a></li>
						</ol>
					</nav>
				</div>
			</div>
					...
					<form>
						...
						<div class="row mb-3">
							<div class="col-xl-12 col-md-12">
								<button type="button" class="btn btn-main">Change password</button>
							</div>
						</div>
					</form>
				</div>
