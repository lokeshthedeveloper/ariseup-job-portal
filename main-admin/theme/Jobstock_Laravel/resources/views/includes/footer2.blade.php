        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-2 col-md-4">
                    <div class="footer-widget">
                        <h4 class="widget-title text-main">For Clients</h4>
                ...
                <div class="col-lg-2 col-md-4">
                    <div class="footer-widget">
                        <h4 class="widget-title text-main">Our Resources</h4>
                        <ul class="footer-menu">
                ...
                <div class="col-lg-2 col-md-6">
                    <div class="footer-widget">
                        <h4 class="widget-title text-main">The Company</h4>
                        <ul class="footer-menu">
