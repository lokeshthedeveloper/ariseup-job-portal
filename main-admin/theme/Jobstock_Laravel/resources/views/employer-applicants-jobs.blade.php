<!-- resources/views/employer-applicants-jobs.blade.php -->
@extends('layouts.main')

@section('title', 'Employer-Applicants-Jobs Page')
		...
		<div class="dashboard-nav">
			...
			<div class="dashboard-inner">
				<ul data-submenu-title="Main Navigation">
					...
					<li class="active"><a href="{{ url('/employer-applicants-jobs') }}"><i class="fa-solid fa-user-group me-2"></i>Applicants Jobs</a></li>
				...
				<div class="colxl-12 col-lg-12 col-md-12">
					...
					<nav aria-label="breadcrumb">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item"><a href="#" class="text-main">All Applicants</a></li>
						</ol>
					</nav>
				</div>
			</div>
					...
					<div class="card">
						...
						<div class="card-body">
							...
							<div class="row justify-content-start gx-3 gy-4">
								...
								<!-- includes/For-Employer/employer-dashboard/list.blade.php -->
								@include('includes.For-Employer.employer-dashboard.list')
