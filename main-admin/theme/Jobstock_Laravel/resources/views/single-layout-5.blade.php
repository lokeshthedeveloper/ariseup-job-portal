<!-- resources/views/single-layout-5.blade.php -->
@extends('layouts.main')

@section('title', 'Single-Layout-5 Page')
...
<!-- Header Top Start -->
<section class="bg-cover bg-second position-relative py-4">
				...
				<div class="bread-wraps breadcrumbs light">
					<nav aria-label="breadcrumb">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item"><a href="{{ url('/grid-style-1') }}">Career</a></li>
				...
				<div class="jbs-head-bodys-top my-5">
					<div class="jbs-roots-y1 flex-column justify-content-start align-items-start">
						<div class="jbs-roots-y1-last">
							<div class="jbs-urt mb-2"><span class="label text-secondcolor bg-white rounded-pill">Full Time</span></div>
							<div class="jbs-title-iop mb-1"><h2 class="m-0 fs-2 text-light">Sr. Front-end Designer</h2></div>
						...
						<div class="jbs-roots-y6 py-3">
							<button class="btn btn-main fw-medium px-lg-5 px-4 me-3" type="button" data-bs-toggle="modal" data-bs-target="#applyjob">Apply Job</button>
				...
				<div class="explot-info-details d-inline-flex flex-wrap">
					<div class="single-explot d-flex align-items-center me-md-5 me-3 my-2">
						<div class="single-explot-first">
							<i class="fa-solid fa-business-time text-main fs-1"></i>
						</div>
					...
					<div class="single-explot d-flex align-items-center me-md-5 me-3 my-2">
						<div class="single-explot-first">
							<i class="fa-solid fa-location-dot text-main fs-1"></i>
						</div>
						<div class="single-explot-last ps-2">
					...
					<div class="single-explot d-flex align-items-center">
						<div class="single-explot-first">
							<i class="fa-solid fa-sack-dollar text-main fs-1"></i>
						</div>
						<div class="single-explot-last ps-2">
				...
				<div class="side-jbs-info-blox bg-white mb-4">
					<div class="side-jbs-info-header">
						<div class="side-jbs-info-thumbs">
							<figure><img src="{{ asset('assets/img/l-12.png') }}" class="img-fluid" alt=""></figure>
						</div>
				...
				<div class="side-rtl-jbs-block">
					...
					<div class="side-rtl-jbs-body">
						<div class="side-rtl-jbs-groups">
							...
							<!-- includes/For-Candidate/Single-job-Detail/related.blade.php -->
							@include('includes.For-Candidate.Single-job-Detail.related')
