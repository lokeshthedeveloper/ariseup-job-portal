<!-- resources/views/employer-package.blade.php -->
@extends('layouts.main')

@section('title', 'Employer-Package Page')
		...
		<div class="dashboard-nav">
			...
			<div class="dashboard-inner">
				<ul data-submenu-title="Main Navigation">
					...
					<li class="active"><a href="{{ url('/employer-package') }}"><i class="fa-solid fa-wallet me-2"></i>Package</a></li>
				...
				<div class="colxl-12 col-lg-12 col-md-12">
					...
					<nav aria-label="breadcrumb">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item"><a href="#" class="text-main">My Package</a></li>
						</ol>
					</nav>
				</div>
			</div>
							...
							<div class="table-responsive">
								<table class="table">
									...
									<tbody>
										...
										<!-- includes/For-Employer/employer-dashboard/table.blade.php -->
										@include('includes.For-Employer.employer-dashboard.table')
