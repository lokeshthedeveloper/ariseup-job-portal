<!-- resources/views/candidate-alert-job.blade.php -->
@extends('layouts.main')

@section('title', 'Candidate-Alert-Job Page')
		...
		<div class="dashboard-nav">
			...
			<div class="dashboard-inner">
				<ul data-submenu-title="Main Navigation">
					...
					<li class="active"><a href="{{ url('/candidate-alert-job') }}"><i class="fa-solid fa-bell me-2"></i>Alert Jobs<span class="count-tag bg-warning">4</span></a></li>
				...
				<div class="colxl-12 col-lg-12 col-md-12">
					...
					<nav aria-label="breadcrumb">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item"><a href="#" class="text-main">Alert Jobs</a></li>
						</ol>
					</nav>
				</div>
			</div>
									...
									<tbody>
										<tr>
											...
											<td>
												...
												<a href="JavaScript:Void(0);" class="btn btn-md btn-light-green px-3"><i class="fa-solid fa-eye"></i></a>
											</td>
										</tr>
										<tr>
											<td>IOS Developer</td>
