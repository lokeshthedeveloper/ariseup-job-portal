<!-- resources/views/candidate-follow-employers.blade.php -->
@extends('layouts.main')

@section('title', 'Candidate-Follow-Employers Page')
		...
		<div class="dashboard-nav">
			...
			<div class="dashboard-inner">
				<ul data-submenu-title="Main Navigation">
					...
					<li class="active"><a href="{{ url('/candidate-follow-employers') }}"><i class="fa-solid fa-user-clock me-2"></i>Following Employers</a></li>
				...
				<div class="colxl-12 col-lg-12 col-md-12">
					...
					<nav aria-label="breadcrumb">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item"><a href="#" class="text-main">Following Employers</a></li>
						</ol>
					</nav>
				</div>
			</div>
