<!-- resources/views/list-style-1.blade.php -->
@extends('layouts.main')

@section('title', 'List-Style-1 Page')
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12 col-md-12">
				...
				<h2 class="ipt-title">Job Style List 01</h2>
				<div class="breadcrumbs light">
					<nav aria-label="breadcrumb">
						<ol class="breadcrumb">
							<li class="breadcrumb-item"><a href="JavaScript:Void(0);">Home</a></li>
							<li class="breadcrumb-item"><a href="JavaScript:Void(0);">Candidate</a></li>
							<li class="breadcrumb-item active" aria-current="page">Job List 01</li>
						</ol>
					</nav>
				</div>
			</div>
		...
		<div class="row">
			...
			<div class="col-lg-9 col-md-12 col-sm-12">
				...
				<div class="row justify-content-start gx-3 gy-4">
					...
					<!-- includes/For-Candidate/Browse-Jobs/list-style-1/jobs12.blade.php -->
					@include('includes.For-Candidate.Browse-Jobs.list-style-1.jobs12')
