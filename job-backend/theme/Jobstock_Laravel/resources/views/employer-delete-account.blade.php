<!-- resources/views/employer-delete-account.blade.php -->
@extends('layouts.main')

@section('title', 'Employer-Delete-Account Page')
		...
		<div class="dashboard-nav">
			...
			<div class="dashboard-inner">
				<ul data-submenu-title="Main Navigation">
					...
					<li class="active"><a href="{{ url('/employer-delete-account') }}"><i class="fa-solid fa-trash-can me-2"></i>Delete Account</a></li>
				...
				<div class="colxl-12 col-lg-12 col-md-12">
					...
					<nav aria-label="breadcrumb">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item"><a href="#" class="text-main">Delete Account</a></li>
						</ol>
					</nav>
				</div>
			</div>
					...
					<form>
						...
						<div class="row mb-3">
							<div class="col-xl-12 col-md-12">
								<button type="button" class="btn btn-danger px-5">Delete Account</button>
							</div>
						</div>
					</form>
				</div>
