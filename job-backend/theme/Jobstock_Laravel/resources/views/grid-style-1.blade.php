<!-- resources/views/grid-style-1.blade.php -->
@extends('layouts.main')

@section('title', 'Grid-Style-1 Page')
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12 col-md-12">
				...
				<h2 class="ipt-title">Grid Style Jobs 01</h2>
				<div class="breadcrumbs light">
					<nav aria-label="breadcrumb">
						<ol class="breadcrumb">
							<li class="breadcrumb-item"><a href="JavaScript:Void(0);">Home</a></li>
							<li class="breadcrumb-item"><a href="JavaScript:Void(0);">Candidate</a></li>
							<li class="breadcrumb-item active" aria-current="page">Job Grid 01</li>
						</ol>
					</nav>
				</div>
			</div>
		...
		<div class="row">
			...
			<div class="col-xxl-9 col-xl-8 col-lg-8 col-md-12 col-sm-12">
				...
				<div class="row justify-content-center gx-xl-3 gx-3 gy-4">
					...
					<!-- includes/For-Candidate/Browse-Jobs/grid-style-1/jobs5.blade.php -->
					@include('includes.For-Candidate.Browse-Jobs.grid-style-1.jobs5')
