<!-- Call To Action -->
<section class="bg-cover call-action-container dark bg-main" style="background:url({{ asset('assets/img/footer-bg-dark.png') }})no-repeat;">
    <div class="container">
                    ...
                    <div class="call-action-form">
                        <form>
                            <div class="newsltr-form">
                                ...
                                <button type="button" class="btn btn-dark px-4">Subscribe</button>
                            </div>
                        </form>
                    </div>
                </div>
