...
@section('title', 'Candidate-Saved-Jobs Page')
		...
		<div class="dashboard-nav">
			...
			<div class="dashboard-inner">
				<ul data-submenu-title="Main Navigation">
					...
					<li class="active"><a href="{{ url('/candidate-saved-jobs') }}"><i class="fa-solid fa-bookmark me-2"></i>Shortlist Jobs</a></li>
				...
				<div class="colxl-12 col-lg-12 col-md-12">
					...
					<nav aria-label="breadcrumb">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item"><a href="#" class="text-main">Shortlisted jobs</a></li>
						</ol>
					</nav>
				</div>
			</div>
					...
					<div class="card">
						...
						<div class="card-body">
							...
							<div class="row justify-content-start gx-3 gy-4">
								...
								<!-- includes/For-Candidate/candidate-dashboard/jobs20.blade.php -->
								@include('includes.For-Candidate.candidate-dashboard.jobs20')
