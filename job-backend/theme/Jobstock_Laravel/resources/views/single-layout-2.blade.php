<!-- resources/views/single-layout-2.blade.php -->
@extends('layouts.main')

@section('title', 'Single-Layout-2 Page')
			...
			<div class="col-lg-11 col-md-12">
				...
				<div class="jbs-dts-block styl-02">
					<div class="jbs-head-block">
						<div class="jbs-head-tops bg-cover" style="background:url({{ asset('assets/img/blog-4.jpg') }}) no-repeat;">
							<div class="ht-200"></div>
						</div>
						<div class="jbs-head-bodys">
							<div class="jbs-head-bodys-top">
								<div class="jbs-roots-y1">
									<div class="jbs-roots-y1-first"><div class="jbs-roots-thumb"><figure><img src="{{ asset('assets/img/l-4.png') }}" class="img-fluid" alt=""></figure></div></div>
									<div class="jbs-roots-y1-last">
										<div class="jbs-urt"><span class="label text-main bg-light-main">Full Time</span></div>
								...
								<div class="jbs-roots-y2">
									<div class="jbs-roots-action-groups">
										<div class="jbs-roots-action-btns">
											<button type="button" class="btn btn-md btn-main" data-bs-toggle="modal" data-bs-target="#applyjob">Quick Apply</button>
											<button type="button" class="btn btn-md btn-gray ms-2"><i class="fa-solid fa-heart me-2"></i>Save Job</button>
										</div>
							...
							<div class="jbs-head-bodys-foot">
								<div class="jbs-info-detail-yelos">
									<div class="signle-jbs-info-yelos">
										...
										<div class="signle-yelos-title"><h6 class="m-0 text-main">Full Time</h6></div>
									</div>
									<div class="signle-jbs-info-yelos">
										<div class="signle-yelos-subtitle"><span class="text-sm-muted mb-1">Experience</span></div>
										<div class="signle-yelos-title"><h6 class="m-0 text-main">10 Years</h6></div>
									</div>
									<div class="signle-jbs-info-yelos">
										<div class="signle-yelos-subtitle"><span class="text-sm-muted mb-1">Sallary</span></div>
										<div class="signle-yelos-title"><h6 class="m-0 text-main">$800-1000/month</h6></div>
									</div>
									<div class="signle-jbs-info-yelos">
										<div class="signle-yelos-subtitle"><span class="text-sm-muted mb-1">Role</span></div>
										<div class="signle-yelos-title"><h6 class="m-0 text-main">Developer</h6></div>
									</div>
								</div>
							</div>										
						</div>
