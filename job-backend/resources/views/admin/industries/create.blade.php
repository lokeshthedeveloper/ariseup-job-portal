...
<div class="row mb-4">
    <div class="col-md-12">
        <h2><i class="bi bi-building"></i> Add New Industry</h2>
                ...
                <form action="{{ route('admin.industries.store') }}" method="POST">
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <button type="submit" class="btn btn-primary">
                            <i class="bi bi-save"></i> Create Industry
                        </button>
                    </div>
                </form>
            </div>
        ...
        <div class="card shadow-sm">
            ...
            <div class="card-body">
                ...
                <div class="alert alert-info small">
                    <i class="bi bi-lightbulb"></i> <strong>Tip:</strong> Use uppercase letters for industry codes for consistency.
                </div>
            </div>
        </div>
    </div>
