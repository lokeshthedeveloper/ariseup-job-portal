...
<div class="row mb-4">
    <div class="col-md-6">
        <h2><i class="bi bi-star"></i> Skills Management</h2>
    </div>
...
<div class="card shadow-sm">
    <div class="card-body">
        <!-- Search and Filter -->
        <form method="GET" action="{{ route('admin.skills.index') }}" class="row g-3 mb-3">
            <div class="col-md-3">
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="{{ route('admin.skills.toggle-status', $skill) }}"
                                    ...
                                    @csrf
                                    @method('PATCH')
                                    <button type="submit" class="btn btn-sm btn-{{ $skill->status ? 'success' : 'secondary' }}">
                    ...
                    @empty
                        <tr>
                            <td colspan="7" class="text-center py-4">
                                ...
                                <p class="text-muted mt-2">No skills found.</p>
                                <a href="{{ route('admin.skills.create') }}" class="btn btn-primary">
