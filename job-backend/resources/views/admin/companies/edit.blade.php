            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select class="form-control @error('company_size') is-invalid @enderror"
                        ...
                        <option value="1-50" {{ old('company_size', $company->company_size) == '1-50' ? 'selected' : '' }}>1-50 employees</option>
                ...
                <div class="col-md-12 mb-3">
                    ...
                    <textarea class="form-control @error('about_us') is-invalid @enderror"
                              id="about_us" name="about_us" rows="4">{{ old('about_us', $company->about_us) }}</textarea>
                    @error('about_us')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="col-md-12 mb-3">
                    ...
                    <textarea class="form-control @error('employee_benefits') is-invalid @enderror"
                              id="employee_benefits" name="employee_benefits" rows="3">{{ old('employee_benefits', $company->employee_benefits) }}</textarea>
                ...
                <div class="col-md-12 mb-3">
                    ...
                    <textarea class="form-control @error('work_culture') is-invalid @enderror"
                              id="work_culture" name="work_culture" rows="3">{{ old('work_culture', $company->work_culture) }}</textarea>
                    @error('work_culture')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="col-md-12 mb-3">
                    ...
                    <textarea class="form-control @error('application_process') is-invalid @enderror"
                              id="application_process" name="application_process" rows="3">{{ old('application_process', $company->application_process) }}</textarea>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="url" class="form-control @error('company_video') is-invalid @enderror"
                           id="company_video" name="company_video" value="{{ old('company_video', $company->company_video) }}">
                    @error('company_video')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="col-md-12 mb-3">
                    ...
                    <textarea class="form-control @error('notable_clients_projects') is-invalid @enderror"
                              id="notable_clients_projects" name="notable_clients_projects" rows="3">{{ old('notable_clients_projects', $company->notable_clients_projects) }}</textarea>
                ...
                <div class="col-md-12 mb-3">
                    ...
                    <textarea class="form-control @error('employee_reviews') is-invalid @enderror"
                              id="employee_reviews" name="employee_reviews" rows="3">{{ old('employee_reviews', $company->employee_reviews) }}</textarea>
                ...
                <div class="col-md-12 mb-3">
                    ...
                    <textarea class="form-control @error('diversity_inclusion') is-invalid @enderror"
                              id="diversity_inclusion" name="diversity_inclusion" rows="3">{{ old('diversity_inclusion', $company->diversity_inclusion) }}</textarea>
                ...
                <div class="col-md-12 mb-3">
                    ...
                    <textarea class="form-control @error('legal_information') is-invalid @enderror"
                              id="legal_information" name="legal_information" rows="3">{{ old('legal_information', $company->legal_information) }}</textarea>
