...
<div class="row mb-4">
    <div class="col-md-12">
        <h2><i class="bi bi-geo-alt"></i> Add New City</h2>
                ...
                <form action="{{ route('admin.cities.store') }}" method="POST">
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <button type="submit" class="btn btn-primary">
                            <i class="bi bi-save"></i> Create City
                        </button>
                    </div>
                </form>
            </div>
        ...
        <div class="card shadow-sm">
            ...
            <div class="card-body">
                ...
                <div class="alert alert-info small">
                    <i class="bi bi-lightbulb"></i> <strong>Tip:</strong> Select a country first, then the state dropdown will be populated with states from that country.
                </div>
            </div>
        </div>
    </div>
